# The name of this view in Looker is "Z to Delete Prebookings Consolidate"
view: z_to_delete_prebookings_consolidate {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.Z_TO_DELETE_PREBOOKINGS_CONSOLIDATE` ;;
