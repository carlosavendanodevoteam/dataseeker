# The name of this view in Looker is "View Searches By Start Date"
view: view_searches_by_start_date {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `analysis-seeker.bi_dataset.VIEW_SEARCHES_BY_START_DATE` ;;
