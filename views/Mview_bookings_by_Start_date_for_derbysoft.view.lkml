view: mview_bookings_by_start_date_for_derbysoft{
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.MVIEW_BOOKINGS_BY_START_DATE` ;;
  ...
  dimension: revenue_eur  {
    type: number
    sql: CASE
            WHEN ${mview_bookings_by_start_date_for_derbysoft.currency} IS NULL OR ${mview_bookings_by_start_date_for_derbysoft.currency} = 'EUR' THEN ${mview_bookings_by_start_date_for_derbysoft.revenue}
            ELSE 0
          END ;;
  }
  dimension: revenue_usd  {
    type: number
    sql:CASE
            WHEN ${mview_bookings_by_start_date_for_derbysoft.currency} = 'USD' THEN ${mview_bookings_by_start_date_for_derbysoft.revenue}
            ELSE 0
          END ;;
  }
  ...
  dimension: cancellation_eur  {
    type: number
    sql:CASE
            WHEN ${mview_bookings_by_start_date_for_derbysoft.currency} IS NULL OR ${mview_bookings_by_start_date_for_derbysoft.currency} = 'EUR' THEN ${mview_bookings_by_start_date_for_derbysoft.cancellation}
            ELSE 0
          END ;;
  }

  dimension: cancellation_usd  {
    type: number
    sql:CASE
            WHEN ${mview_bookings_by_start_date_for_derbysoft.currency} = 'USD' THEN ${mview_bookings_by_start_date_for_derbysoft.cancellation}
            ELSE 0
          END ;;
  }
