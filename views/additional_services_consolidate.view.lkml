# The name of this view in Looker is "Additional Services Consolidate"
view: additional_services_consolidate {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.ADDITIONAL_SERVICES_CONSOLIDATE` ;;
