# The name of this view in Looker is "Z to Delete Satisfaction Form Text Answers"
view: z_to_delete_satisfaction_form_text_answers {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.Z_TO_DELETE_SATISFACTION_FORM_TEXT_ANSWERS` ;;
