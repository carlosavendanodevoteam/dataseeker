...
view: hotels_data {
  ...
  dimension: continent {
    ...
    sql: Case
          ...
          'REPÚBLICA DOMINICANA', 'PANAMA', 'PERÚ', 'PERU', 'PUERTO RICO') and ${hotel_code} not in('serenade-all-suites','best-serenade','impressive-puntacana','impressive-premium','casual-belle-epoque','casual-incas','casual-raizes','smy-lisboa','smy-eulalia-algarve','vik-cayena','vik-arenablanca', 'summum-poblado-suites','habitus-mesod-jungle', 'o7-bluebay-villasdoradas', 'o7-bluebay-esmeralda', 'smy-territorio') then '2' --Latam
