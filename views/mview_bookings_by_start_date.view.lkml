# The name of this view in Looker is "Mview Bookings By Start Date"
view: mview_bookings_by_start_date {
  ...
  dimension: cancellation_usd  {
    type: number
    sql:CASE
      WHEN ${mview_bookings_by_start_date.currency} = 'USD' THEN ${mview_bookings_by_start_date.cancellation}
      ELSE 0
    END ;;
  }
