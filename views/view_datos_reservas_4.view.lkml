# The name of this view in Looker is "View Datos Reservas 4"
view: view_datos_reservas_4 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.VIEW_DATOS_RESERVAS_4` ;;
  ...
  dimension: timestamp_date_datos_reservas_4 {
    type: string
