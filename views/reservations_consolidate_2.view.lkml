# The name of this view in Looker is "Reservations Consolidate 2"
view: reservations_consolidate_2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.RESERVATIONS_CONSOLIDATE_2` ;;
  ...
  dimension: timestamp_date_consolidate_2 {
    type: string
