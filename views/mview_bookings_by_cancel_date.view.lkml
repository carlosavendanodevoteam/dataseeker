# The name of this view in Looker is "Mview Bookings By Cancel Date"
view: mview_bookings_by_cancel_date {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.MVIEW_BOOKINGS_BY_CANCEL_DATE` ;;
  ...
  dimension: timestamp_date_bookings_by_cancel_date {
    type: string
