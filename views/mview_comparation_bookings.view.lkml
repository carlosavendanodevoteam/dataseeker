...
view: mview_comparation_bookings {
  ...
  dimension: source_fixed {
    ...
    sql: CASE
          ...
          WHEN ${TABLE}.source_fixed like '%Callcenter%' or ${TABLE}.identifier LIKE 'R%' THEN 'Callcenter'
  ...
  dimension: rateName_fixed {
    ...
    sql:Case
          ...
          when UPPER(${rate_name}) like '%PAGO DIRECTO EN%' or UPPER(${rate_name}) like '%PAGA DIRECTAMENTE EN %' then 'direct payment at the hotel'
          else 'Other'
        End;;
  }
