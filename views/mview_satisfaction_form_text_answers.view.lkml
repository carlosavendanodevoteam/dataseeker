# The name of this view in Looker is "Mview Satisfaction Form Text Answers"
view: mview_satisfaction_form_text_answers {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.MVIEW_COMPARATION_SATISFACTION_FORM_TEXT_ANSWERS` ;;
