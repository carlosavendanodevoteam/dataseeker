# The name of this view in Looker is "View Datos Reservas 5"
view: view_datos_reservas_5 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.VIEW_DATOS_RESERVAS_5` ;;
  ...
  dimension: timestamp_date_datos_reservas_5 {
    type: string
