# The name of this view in Looker is "Z to Delete View Datos Reservas 4 Old Copy"
view: z_to_delete_view_datos_reservas_4_old_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.Z_TO_DELETE_VIEW_DATOS_RESERVAS_4_OLD_COPY` ;;
  ...
  dimension: timestamp_date_reservas_4_old_copy {
    type: string
