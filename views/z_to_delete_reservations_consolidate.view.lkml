# The name of this view in Looker is "Z to Delete Reservations Consolidate"
view: z_to_delete_reservations_consolidate {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bi_dataset.Z_TO_DELETE_RESERVATIONS_CONSOLIDATE` ;;
  ...
  dimension: timestamp_date_reservations_consolidate {
    type: string
